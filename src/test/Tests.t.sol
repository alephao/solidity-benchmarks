...
import { ERC721OZEnumMinimal } from "$/ERC721OZEnumMinimal.sol";
import { ERC721AMinimal } from "$/ERC721AMinimal.sol";
import { ERC721BMinimal } from "$/ERC721BMinimal.sol";
import { ERC721KMinimal } from "$/ERC721KMinimal.sol";
...
contract ERC721OZEnumMintTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);

    ERC721OZEnumMinimal internal sut;

    function setUp() public {
        sut = new ERC721OZEnumMinimal();
    }
...
contract ERC721OZEnumTransferTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);
...
contract ERC721OZEnumApprovalTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);
...
contract ERC721KMintTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);

    ERC721KMinimal internal sut;

    function setUp() public {
        sut = new ERC721KMinimal();
    }
...
contract ERC721KTransferTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);
...
contract ERC721KApprovalTest is DSTest {
    Vm internal constant HEVM = Vm(HEVM_ADDRESS);
